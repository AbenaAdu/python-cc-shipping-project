...
if weight > 0 and weight <= 2:
  print(greeting_for_ground_shipping_cost, flat_charge_ground_shipping + (weight * 1.50))
elif weight > 2 and weight <= 6:
  print(greeting_for_ground_shipping_cost, flat_charge_ground_shipping + (weight * 3.00))
elif weight > 6 and weight <= 10:
  print(greeting_for_ground_shipping_cost, flat_charge_ground_shipping + (weight * 4.00))
elif weight > 10:
  print(greeting_for_ground_shipping_cost, flat_charge_ground_shipping + (weight * 4.75))
else:
  print(error_message)
...
if weight > 0:
  print(greeting_for_ground_premium_shipping_cost, flat_charge_ground_shipping_premium)
else:
  print(error_message)
...
if weight > 0 and weight <= 2:
  print(greeting_for_drone_shipping_cost, weight * 4.50)
elif weight > 2 and weight <= 6:
  print(greeting_for_drone_shipping_cost, weight * 9.00)
elif weight > 6 and weight <= 10:
  print(greeting_for_drone_shipping_cost, weight * 12)
elif weight > 10:
  print(greeting_for_drone_shipping_cost, weight * 14.25)
else:
  print(error_message)
